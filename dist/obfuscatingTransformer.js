...
var additionalDir = path.join(app_root_path_1.path, "core");
function obfuscatingTransformer(_a) {
    var _b = _a.filter, filter = _b === void 0 ? function (filename) { return filename.startsWith(sourceDir) || filename.startsWith(additionalDir); } : _b, _c = _a.upstreamTransformer, upstreamTransformer = _c === void 0 ? getMetroTransformer_1.getMetroTransformer() : _c, _obfuscatorOptions = _a.obfuscatorOptions, otherOptions = __rest(_a, ["filter", "upstreamTransformer", "obfuscatorOptions"]);
